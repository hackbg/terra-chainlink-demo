...
if [[ "$OSTYPE" == "linux-gnu"* ]]; then
    ...
    ./gauntlet-terra-linux setupFeed --network=$NETWORK --paymentAmount=1 --minSubmissionValue=0 --maxSubmissionValue=99999999999999999999999999999 --minSubmissionCount=1 --timeout=60 --decimals=8 --description=ETH/USD --rdd=./scripts/terrajs/addresses.json terra1757tkx08n0cqrw7p86ny9lnxsqeth0wgp0em95 terra17lmam6zguazs5q5u6z5mmx76uj63gldnse2pdp terra199vw7724lzkwz6lf2hsx04lrxfkz09tg8dlp6r
    ./gauntlet-terra-linux setupFeed --network=$NETWORK --paymentAmount=1 --minSubmissionValue=0 --maxSubmissionValue=99999999999999999999999999999 --minSubmissionCount=1 --timeout=60 --decimals=8 --description=AAPL/USD --rdd=./scripts/terrajs/addresses.json terra1757tkx08n0cqrw7p86ny9lnxsqeth0wgp0em95 terra17lmam6zguazs5q5u6z5mmx76uj63gldnse2pdp terra199vw7724lzkwz6lf2hsx04lrxfkz09tg8dlp6r
    ./gauntlet-terra-linux setupFeed --network=$NETWORK --paymentAmount=1 --minSubmissionValue=0 --maxSubmissionValue=99999999999999999999999999999 --minSubmissionCount=1 --timeout=60 --decimals=8 --description=GOOGL/USD --rdd=./scripts/terrajs/addresses.json terra1757tkx08n0cqrw7p86ny9lnxsqeth0wgp0em95 terra17lmam6zguazs5q5u6z5mmx76uj63gldnse2pdp terra199vw7724lzkwz6lf2hsx04lrxfkz09tg8dlp6r
    ./gauntlet-terra-linux setupFeed --network=$NETWORK --paymentAmount=1 --minSubmissionValue=0 --maxSubmissionValue=99999999999999999999999999999 --minSubmissionCount=1 --timeout=60 --decimals=8 --description=FB/USD --rdd=./scripts/terrajs/addresses.json terra1757tkx08n0cqrw7p86ny9lnxsqeth0wgp0em95 terra17lmam6zguazs5q5u6z5mmx76uj63gldnse2pdp terra199vw7724lzkwz6lf2hsx04lrxfkz09tg8dlp6r
    ./gauntlet-terra-linux setupFeed --network=$NETWORK --paymentAmount=1 --minSubmissionValue=0 --maxSubmissionValue=99999999999999999999999999999 --minSubmissionCount=1 --timeout=60 --decimals=8 --description=AMZN/USD --rdd=./scripts/terrajs/addresses.json terra1757tkx08n0cqrw7p86ny9lnxsqeth0wgp0em95 terra17lmam6zguazs5q5u6z5mmx76uj63gldnse2pdp terra199vw7724lzkwz6lf2hsx04lrxfkz09tg8dlp6r
